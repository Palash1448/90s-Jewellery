...
export const DEFAULT_SETTINGS: StoreSettings = {
  ...
  logoUrl: '',
  faviconUrl: '',
  whatsappNumber: import.meta.env.VITE_WHATSAPP_NUMBER || '917507629997',
  ...
  shippingPolicy: 'We provide free door-to-door insured delivery across Maharashtra and flat ₹50 shipping across the rest of India. Orders are dispatched within 24 hours of confirmation. All shipments are insured against transit damage.',
